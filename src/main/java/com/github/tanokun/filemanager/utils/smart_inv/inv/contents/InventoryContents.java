package com.github.tanokun.filemanager.utils.smart_inv.inv.contents;
...
public interface InventoryContents
{
    ...
    InventoryContents removeProperty(String name);
    ...
    class Impl implements InventoryContents
    {
        ...
        public Impl(SmartInventory inv, Player player) {
            ...
            try {
                if (!inv.getManager().getContents(player).get().getProperties().isEmpty()) {
                    this.properties = inv.getManager().getContents(player).get().getProperties();
                }
        ...
        @Override
        public InventoryContents removeProperty(String name)
        {
